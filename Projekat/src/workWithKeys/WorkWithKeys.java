...
public class WorkWithKeys {
	...
	*/
	...
	public static String hash(String passwordToHash) {
		String salt = "12345678";
		 ...
		 try {
			 ...
			 byte[] hashBytes = md.digest(passwordToHash.getBytes(StandardCharsets.UTF_8));
	...
	public static void encryption(Key symmetricKey) throws Exception {
		byte[] bytes = Files.readAllBytes(Paths.get("C:\\Users\\Bojan\\Documents\\Repository\\Directory1\\PlainText.txt"));
	...
	public static void decryption(Key symmetricKey) throws Exception {
		byte[] bytes = Files.readAllBytes(Paths.get("C:\\Users\\Bojan\\Documents\\Repository\\Directory1\\Cipher.txt"));
		Cipher cipher = Cipher.getInstance("AES");
		cipher.init(Cipher.DECRYPT_MODE, symmetricKey);
		byte[] cipherText = cipher.doFinal(bytes);
		FileOutputStream fos = new FileOutputStream("C:\\Users\\Bojan\\Documents\\Repository\\Directory1\\PlainText1.txt");
		fos.write(cipherText);
		fos.close();
	}
